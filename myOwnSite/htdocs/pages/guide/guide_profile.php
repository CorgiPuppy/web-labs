<?php
    ...
    error_reporting(0);
    if (!$_SESSION['user']) {
        header('Location: guide_index.php');
    }
?>
    ...
    <body>
        <nav>
            ...
            <ul class="links">
                ...
                <li class="link"><a href="../timer/timer_profile.php">Таймер</a></li>
